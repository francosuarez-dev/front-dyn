...
const Header = () => {
    ...
    return (
        <>
            <header className="sticky top-0 w-full shadow-md bg-gradient-to-r from-slate-500 via-purple-500 to-blue-500">
                <nav className="container mx-auto px-4 py-3">
                    <div className='flex justify-between items-center'>
                        <div className='flex items-center'>
                            <img src={margaLogo} className="mr-3 h-9" alt="DyN Logo" />
                            <span className='text-xl font-bold text-white'>Dia y Noche Tickets</span>
                        </div>
